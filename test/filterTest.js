...
describe('filter function', () => {
    ...
    it('should return an empty array when given a null', () => {
        expect(filter(null, () => true)).to.eql([]);  
    });
    it('should return an empty array when given a undefined', () => {
        expect(filter(undefined, () => true)).to.eql([]);
    });   
    it('should return an empty array when given a empty array', () => {
